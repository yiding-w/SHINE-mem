...
def parse_args():
    ...
    parser.add_argument("--facts-path", type=str, default="MemoryTest/json_data/semantic_facts.json", help="Fact JSON generated by MemoryTest.prepare_data.generate_capacity_data.")
