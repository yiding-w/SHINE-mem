...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Compress a context into SHINE LoRA and answer a question.")
    parser.add_argument("--context", type=str, default="Sam is a boy who loves apple. His phone number is 123456.", help="Raw context string.")
    parser.add_argument("--context-file", type=str, help="Path to a UTF-8 text file containing the context.")
    parser.add_argument("--question", type=str, default="Who is Sam? Does he loves apple? What is his phone number?", help="Question to answer.")
    parser.add_argument(
        "--model-path",
        type=str,
        default="/root/data/xyh/SHINE-mem/models/Qwen3-8B",
        help="Path to the local Qwen3-8B model directory.",
    )
    parser.add_argument(
        "--checkpoint-dir",
        type=str,
        default="/root/data/xyh/SHINE-mem/checkpoints/8gpu_8lora_128metalora_lr5e-5_grouppretrain_1150/train/checkpoint-epoch-1",
        help="Path to the SHINE checkpoint directory containing metanetwork.pth and metalora.pth.",
    )
    parser.add_argument(
        "--save-lora-path",
        type=str,
        default="/root/data/xyh/SHINE-mem/generated_case_lora.pt",
    ...
    parser.add_argument("--device", type=str, default="cuda", choices=["cuda", "cpu"], help="Inference device type.")
    parser.add_argument("--gpu-id", type=int, default=1, help="CUDA device index to use when --device=cuda.")
    parser.add_argument("--seed", type=int, default=42, help="Random seed.")
    parser.add_argument("--context-max-length", type=int, default=1550, help="Max tokenized context length.")
    parser.add_argument("--conversation-max-length", type=int, default=5000, help="Max tokenized conversation length.")
    parser.add_argument("--max-new-tokens", type=int, default=128, help="Maximum number of tokens to generate for the answer.")
    parser.add_argument("--lora-r", type=int, default=8, help="LoRA rank used by the SHINE checkpoint.")
    parser.add_argument("--metalora-r", type=int, default=128, help="Meta-LoRA rank used by the SHINE checkpoint.")
    parser.add_argument("--metanetwork-layers", type=int, default=4, help="Number of metanetwork transformer layers.")
