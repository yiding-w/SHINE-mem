...
# transformers 5.x build skew: this version doesn't re-export DynamicCache /
# GenericForSequenceClassification from qwen3_5.modeling_qwen3_5. Inject
# them from their canonical locations so the wildcard-style import below
# still works.
...
if not hasattr(_qwen3_5_mod, "GenericForSequenceClassification"):
    from transformers.modeling_layers import GenericForSequenceClassification as _GFSC
    _qwen3_5_mod.GenericForSequenceClassification = _GFSC
